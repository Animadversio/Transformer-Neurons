...
# layer_num = 0
tokens, _, fetcher = record_activations_for_text(text, model, tokenizer, layer_num=range(len(model.h)))
#%%
import pandas as pd
import matplotlib.pyplot as plt
...
plt.title("GPT2-XL MLP unit activated fraction")
plt.ylabel("act > thresh fraction")
plt.show()
#%%
